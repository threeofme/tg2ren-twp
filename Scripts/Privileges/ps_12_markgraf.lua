...
function GetCompletePrivilegeList()
	return ps_12_markgraf_GetPrivilegeList(), ps_11_graf_GetCompletePrivilegeList()
end

function TakeTitle()
	gameplayformulas_StartHighPriorMusic(MUSIC_POSITIVE_EVENT)
	chr_SetNobilityImpactList("TitleHolder", ps_12_markgraf_GetPrivilegeList())
	...
	feedback_MessageCharacter("",
		...
		"@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_BODY_+0", TitleLabel, BuildLabel, maxworkshops, buildingcount, chr_GeneratePrivilegeListLabels(ps_12_markgraf_GetCompletePrivilegeList()))

end

function LooseTitle()
	chr_RemoveNobilityImpactList("TitleHolder", ps_12_markgraf_GetPrivilegeList())
end
