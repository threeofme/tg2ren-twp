...
function TakeTitle()
	...
	feedback_MessageCharacter("",
		...
		"@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_BODY_+0", TitleLabel, BuildLabel, maxworkshops, buildingcount,chr_GeneratePrivilegeListLabels(ps_10_baron_GetCompletePrivilegeList()))
