...
function TakeTitle()
	...
	chr_SetNobilityImpactList("TitleHolder", ps_02_gemeiner_GetPrivilegeList())
	...
	feedback_MessageCharacter("",
		...
		"@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_BODY_+0", TitleLabel, BuildLabel, maxworkshops, buildingcount, chr_GeneratePrivilegeListLabels(ps_02_gemeiner_GetCompletePrivilegeList()))

end

function LooseTitle()
	chr_RemoveNobilityImpactList("TitleHolder", ps_02_gemeiner_GetPrivilegeList())
end
