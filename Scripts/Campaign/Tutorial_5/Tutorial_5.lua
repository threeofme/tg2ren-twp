-------------------------------------------------------------------------------
----
----	OVERVIEW "Tutorial_5\Tutorial_5"
----
----	Initiates map for Tutorial - Chapter5
----
----	1. function GetWorld
----	2. function Prepare
...
-------------------------------------------------------------------------------
	...
	SimSetLastname("#Spoose", "@L_TUTORIAL_LASTNAME_+1")
	SimSetReligion("#Spoose", 0)
	SimSetMortal("#Spoose", false)
	SetState("#Spoose", STATE_NPC, true)
	SimSetBehavior("#Spoose","")
	SetProperty("#Spoose","NoBard",1)
...
-------------------------------------------------------------------------------
	...
	SetFavorToSim("#TutNPC1","#Player",80)
	...
	SetFavorToSim("#TutNPC2","#Player",20)
...
-------------------------------------------------------------------------------
	...
	StartQuest("Intro5","#Player","",false)
end
