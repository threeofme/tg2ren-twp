-------------------------------------------------------------------------------
----
----	OVERVIEW "Tutorial_6\Tutorial_6"
----
...
function Prepare()
	...
	SetTime(EN_SEASON_SPRING,1404, 5, 0)
...
-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	if not ScenarioCreatePosition(-24382, 5378, "PlayerStartPosition") then
...
-------------------------------------------------------------------------------
	...
	CityGetOffice("#Capital",2,0,"TheOffice")
	SimSetOffice("#TutNPC1","TheOffice")
	SimSetFirstname("#TutNPC1","@L_TUTORIAL_FIRSTNAME_+2")
	SimSetLastname("#TutNPC1","@L_TUTORIAL_LASTNAME_+2")

	if not SimCreate(717, "#TutNPCHome2", "#Market", "#TutNPC2") then
		return "unable to create the npc 'TutNPC2'"
	end

	SetState("#TutNPC2", STATE_NPC, true)
	SetProperty("#TutNPC2","NoBard",1)
	DynastyAddMember("#TutNPCDynastie2","#TutNPC2")
	SimSetBehavior("#TutNPC2", "QuestNPCStrollMarket")
	SimSetMortal("#TutNPC2", false)
	SetFavorToSim("#TutNPC2","#Player",50)
	CityGetOffice("#Capital",1,0,"TheOffice")
	SimSetOffice("#TutNPC2","TheOffice")
...
-------------------------------------------------------------------------------
	...
	StartQuest("Intro6","#Player","",false)
end
