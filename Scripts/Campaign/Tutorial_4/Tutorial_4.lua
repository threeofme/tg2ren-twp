-------------------------------------------------------------------------------
----
----	OVERVIEW "Tutorial_4\Tutorial_4"
----
----	Initiates map for Tutorial - Chapter4
----
----	1. function GetWorld
----	2. function Prepare
...
-------------------------------------------------------------------------------
	...
	CreditMoney("#Player",1000,"STARTUP")	
...
--	ForbidMeasure("#Player", "BuyNobilityTitle", EN_BOTH) -- DA AUCH
--	ForbidMeasure("#Player", "ChangeFaith", EN_BOTH)
--	ForbidMeasure("#Player", "ChargeCharacter", EN_BOTH)
--	ForbidMeasure("#Player", "CourtLover", EN_BOTH) -- HIER IST ES
--	ForbidMeasure("#Player", "InsultCharacter", EN_BOTH)
--	ForbidMeasure("#Player", "RunForAnOffice", EN_BOTH) -- UND HIER
...
function Start()
	...
	-------------------------------------------------------------------------------
	local Radius = 10000
	if (ScenarioGetObjectByName("Building", "PlayerWorkshop", "#Smithy"))  then
	elseif not Find("#Market", "__F( (Object.GetObjectsByRadius(Building)=="..Radius..")AND(Object.IsBuyable())AND(Object.IsType(7)))","#Smithy", -1) then
		return "no smithy found in "..Capital
	end
	
	SetName("#Smithy", "@L_TUTORIAL_SMITHY")
	if not BuildingBuy("#Smithy", "#Player", BM_STARTUP) then
		return "unable to buy the smithy for the player dynasty"
	end
...
-------------------------------------------------------------------------------
	...
	StartQuest("Intro4","#Player","",false)
end
