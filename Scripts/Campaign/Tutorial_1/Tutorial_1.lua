-------------------------------------------------------------------------------
----
----	OVERVIEW "_Tutorial_1\_Tutorial_1"
----
----	Initiates map for Tutorial - Chapter1
----
----	1. function GetWorld
----	2. function Prepare
...
-------------------------------------------------------------------------------
	...
	NotifyOnStateChange("#Player", STATE_DEAD, "Tutorial_1/Lost1.lua", "OnStateChange")
...
-------------------------------------------------------------------------------
	...
	StartQuest("Intro1","#Player","",false)
end
