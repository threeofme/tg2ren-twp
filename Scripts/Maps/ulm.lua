...
function Prepare()
	ScenarioSetOutdoorScrollBoundaries(-40000, -39623, 45000, -40000, 40000, 39643, -38000, 38000)
	...
	ScenarioGetObjectByName("cl_Building", "#munster", "munster")
	SetName("munster", "@L_MUNSTER_+0")
