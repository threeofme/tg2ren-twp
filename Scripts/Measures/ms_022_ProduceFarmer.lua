function GetLocator()
	...
	local LocatorArray = {
		"Walledge1", ms_022_producefarmer_WorkTable, "",
		"Walledge2", ms_022_producefarmer_WorkTable, "",
		"Walledge3", ms_022_producefarmer_WorkTable, "",
		"Walledge4", ms_022_producefarmer_WorkTable, ""
