...
function Run()
	...
	if (GetState("", STATE_CUTSCENE)) then
		as_usenoblesclothes_Cutscene()
	else
		as_usenoblesclothes_Normal()
	end
end
...
function Normal()
	...
	if RemoveItems("","NoblesClothes",1)>0 then	
		SetRepeatTimer("", GetMeasureRepeatName2("UseNoblesClothes"), TimeOut)
