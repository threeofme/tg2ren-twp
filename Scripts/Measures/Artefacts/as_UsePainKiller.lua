-------------------------------------------------------------------------------
----
----	OVERVIEW "as_UsePainKiller.lua"
----
----	Allows your dynasty members to cure Pneumonia/Blackdeath/Fracture/Caries for themselves.
...
if RemoveItems("","PainKiller",1,INVENTORY_STD) then
