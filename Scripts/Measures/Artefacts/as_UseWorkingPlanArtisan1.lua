-------------------------------------------------------------------------------
----
----	OVERVIEW "as_UseWorkingPlanArtisan1"
----
...
function Run()
	...
	local Plan = "WorkingPlanArtisan1"
	local PlanCount = 1
	local PlanLabel = ItemGetLabel(Plan, true)
	local Object = "ChurchBell"
	local ObjectCount = 1
	local ObjectLabel = ItemGetLabel(Object, true)

	local ItemName1 = "iron"
	local ItemCount1 = 1
	local ItemLabel1 = ItemGetLabel(ItemName1, ItemCount1 == 1)
	local ItemName2 = "silver"
	local ItemCount2 = 1
	local ItemLabel2 = ItemGetLabel(ItemName2, ItemCount2 == 1)
	local ItemName3 = "Tool"
	local ItemCount3 = 1
	local ItemLabel3 = ItemGetLabel(ItemName3, ItemCount3 == 1)
