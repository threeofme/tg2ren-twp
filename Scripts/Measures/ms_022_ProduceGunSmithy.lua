function GetLocator()
	...
	local LocatorArray = {
		"TakeToolPos", ms_022_producegunsmithy_UseAnvil, "",
		"AirPos", ms_022_producegunsmithy_UseBellow, "bellow",
		"Tool2Pos", ms_022_producegunsmithy_UseWeaponRack, "weaponrack",
		"Pedestral", ms_022_producegunsmithy_UsePedestral, "",
		"Shelf_in_the_wall", ms_022_producegunsmithy_UseShelf_in_the_wall, "",
		"Meltingpot",ms_022_producegunsmithy_UseMeltingpot, "",
		"MagnifyPos",ms_022_producegunsmithy_UseMagnify, "magnifyingglas",
		"Tool1Pos",ms_022_producegunsmithy_UseFineTools, "engravingtoolset",
		"Tool2Pos",ms_022_producegunsmithy_UseFineTools2, "fileshelf",
		"canonpos",ms_022_producegunsmithy_UseCannon, "cannonmold",
		"Forge2",ms_022_producegunsmithy_UseHammerInstallation, "",
		"Pedestral", ms_022_producegunsmithy_UsePedestral, "",
	}
	IncrementXPQuiet("",3)
